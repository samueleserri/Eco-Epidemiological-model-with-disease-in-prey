...
\begin{itemize}
  \item \textcolor{blue!50}{Ecological models} $\rightarrow$ study interactions between species and their environment.
  \item \textcolor{blue!50}{Epidemiological models} $\rightarrow$ study the spread of diseases in populations.
\end{itemize}
\begin{block}{Eco-epidemiological models}
  Combine both aspects to study the interactions between species while considering the impact of diseases on population dynamics.
\end{block}
\end{frame}

\subsection{The model studied}

\begin{frame}{Hypoteses of the model.}
  \begin{enumerate}
    \item The prey population is divided into susceptible and infected individuals.
    \item In the absence of disease the prey population density grows according
to a logistic curve with carrying capacity K and intrinsic growth rate r. 
    \item Only the susceptible prey are able to reproduce.
    \item Disease spread in the prey population only. The infected populations do not recover or become immune. 
    \item We assume that the predator eats only the infected prey with ratio-dependent Michaelis–Menten functional response function.\footnote{See: J. Chattopadhyay, O. Arino, A predator–prey model with disease in the prey, Nonlinear Anal.
36 (1999) 749–766.}
  \end{enumerate}
  ...
  \begin{flushright}
    \begin{figure}
      ...
      \begin{minipage}{0.45\textwidth}
        ...
        \caption{Plot of one orbit for $r=0.02$.}
      \end{minipage}
      \hfill
      \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imgs/EX2/Phase_space_r_equal_6_8.png}
        \caption{Plot of one orbit for $r=6.05$.}
      \end{minipage}
    \end{figure}
...
\begin{frame}{Comparison between Equilibria $E_1$ and $E_2$ and $r$.}  \begin{flushright}
    \begin{figure}
      \centering
      \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imgs/EX2/population_vs_r.png}
        \caption{Population vs $r$ for Equilibrium $E_2$.}
      \end{minipage}
      \hfill
      \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imgs/EX2/population_vs_r_e1.png}
        \caption{Population vs $r$ for Equilibrium $E_1$.}
      \end{minipage}
    \end{figure}
  \end{flushright}
  ...
  \begin{flushright}
    \begin{figure}
      ...
      \begin{minipage}{0.45\textwidth}
        ...
        \caption{Plot of one orbit for $c=1.5$.}
      \end{minipage}
      \hfill
      \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imgs/EX3/Ex3_phase_space_c_equal_1.png}
        \caption{Plot of one orbit for $c=1$.}
      \end{minipage}
    \end{figure}
  \end{flushright}
\end{frame}

\begin{frame}{Population vs $c \in [0.5, 2.5]$.}
  \begin{figure}
    \centering
    \includegraphics[width=.6\textwidth]{Imgs/EX3/population_vs_c.png}
    \caption{Population vs $c \in [0.5,2.5]$.}
  \end{figure}
\end{frame}
...
\begin{frame}{Population vs $K \in [2, 8]$.}
  \begin{figure}
    \centering
    \includegraphics[width=.6\textwidth]{Imgs/EX4/population_vs_K.png}
    \caption{Population vs $K \in [2,8]$.}
  \end{figure}
\end{frame}
  ...
  \begin{flushright}
    \begin{figure}
      ...
      \begin{minipage}{0.45\textwidth}
        ...
        \caption{Plot of one orbit for $k=0.3$.}
      \end{minipage}
      \hfill
      \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imgs/EX6/ex_6_pahse_diagram_k_equal_0_8.png}
        \caption{Plot of one orbit for $k=0.8$.}
      \end{minipage}
    \end{figure}
  \end{flushright}
\end{frame}

\begin{frame}{Influence of the parameters $b$ and $k$ on populations.}  \begin{flushright}
    \begin{figure}
      \centering
      \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imgs/EX6/pop_vs_k.png}
        \caption{$b$ fixed and varying $k$.}
      \end{minipage}
      \hfill
      \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Imgs/EX6/popultaions_vs_b.png}
        \caption{$k$ fixed and varying $b$.}
      \end{minipage}
    \end{figure}
  \end{flushright}
...
\begin{frame}{Influence of $\beta$ on the endemic equilibrium}
  \begin{figure}
  \centering
  \includegraphics[width=.6\textwidth]{Imgs/EX7/population_vs_beta.png}
  \caption{$b = 0.3, c = 0.1, d = 0.04, k  = 0.34, m = 0.4, r = 1.2, K = 6, \beta \in [0.01,0.5], S0 = 2, I0 = 1.5, Y0 = 1$}
  \end{figure}
\end{frame}

\section*{Summary}

\begin{frame}{Summary}{The discrete-time model exhibits a richer dynamical behavior compared to its continuous-time counterpart.}
  \begin{itemize}
  \item
    When \alert{$\mathcal{R}_0 > 1$}  and \alert{$bk < d$}: $S$ and $I$ coexist while $Y$ becomes extinct.
  \item
    \alert{$r,K,\beta,c$} directly influence the dynamical behaviors of the system.
    By varying these parameters, we observe \alert{local stability}, \alert{period-doubling bifurcations}, \alert{Hopf bifurcations}, and even \alert{chaotic dynamics}.
  \item
    When \alert{$b$} and \alert{$k$} increase, $Y$ increase and $I$ decrease. If $b$ is large this can lead to the extinction of $I$ and ultimately $Y$
    (since predators can only eat infected prey).
  \end{itemize}
...
%     \begin{itemize}
%     \item
%       Study the case where $S$ is also predated.
%     \item
...
\begin{frame}[allowframebreaks]
  ...
  \bibitem{Author1990}
    Zengyun Hu, Zhidong Teng, Chaojun Jia, Long Zhang and Xi Chen
    \newblock {\em Complex dynamical behaviors in a discrete
eco-epidemiological model with disease in
prey}.
    \newblock Advances in Diﬀerence Equations 2014
    \newblock \url{http://www.advancesindifferenceequations.com/content/2014/1/265}
  \end{thebibliography}
\end{frame}
\end{document}